...
{
    6,                /* Minimum connection interval - 400 x 1.25 = 500 ms */
    6,                /* Maximum connection interval - 400 x 1.25 = 500 ms */
    13,                  /* Slave latency - 1 */
    500                 /* Supervision timeout - 500 x 10 = 5000 ms */
};

#define NUMBER_OF_FSR (32) 
#define BYTES_FOR_FSRS 16 // 10 bits for FSR
uint16 Fsrs[4][8]; //Data from the ADC.
...
//
//CYBLE_GATTS_HANDLE_VALUE_NTF_T 	MUX0Handle;
//CYBLE_GATTS_HANDLE_VALUE_NTF_T 	MUX1Handle;
//CYBLE_GATTS_HANDLE_VALUE_NTF_T 	MUX2Handle;
//CYBLE_GATTS_HANDLE_VALUE_NTF_T 	MUX3Handle;


CYBLE_GATTS_HANDLE_VALUE_NTF_T 	RAW0Handle;
CYBLE_GATTS_HANDLE_VALUE_NTF_T 	RAW1Handle;
CYBLE_GATTS_HANDLE_VALUE_NTF_T 	RAW2Handle;

CYBLE_GATTS_HANDLE_VALUE_NTF_T 	IMUHandle;
