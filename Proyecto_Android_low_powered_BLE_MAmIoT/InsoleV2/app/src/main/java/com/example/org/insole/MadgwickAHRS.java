...
public double[] getRollPitchYaw(){
    double[] RollPitchYaw=new double[3];
//    yawrollpitch[0]  = Math.atan2(2.0f * (quaternion[1] * quaternion[2] + quaternion[0] * quaternion[3]), quaternion[0] * quaternion[0] + quaternion[1] * quaternion[1] - quaternion[2] * quaternion[2] - quaternion[3] * quaternion[3]);
//    yawrollpitch[2]  = -Math.asin(2.0f * (quaternion[1] * quaternion[3] - quaternion[0] * quaternion[2]));
//    yawrollpitch[1]  =  Math.PI-Math.atan2(2.0f * (quaternion[0] * quaternion[1] + quaternion[2] * quaternion[3]), quaternion[0] * quaternion[0] - quaternion[1] * quaternion[1] - quaternion[2] * quaternion[2] + quaternion[3] * quaternion[3]);
//    return yawrollpitch;

    RollPitchYaw[0] = Math.atan2(quaternion[0]*quaternion[1] + quaternion[2]*quaternion[3], 0.5f - quaternion[1]*quaternion[1] - quaternion[2]*quaternion[2]);
    RollPitchYaw[1] = Math.asin(-2.0f * (quaternion[1]*quaternion[3] - quaternion[0]*quaternion[2]));
    RollPitchYaw[2] = Math.atan2(quaternion[1]*quaternion[2] + quaternion[0]*quaternion[3], 0.5f - quaternion[2]*quaternion[2] - quaternion[3]*quaternion[3]);
    return RollPitchYaw;
}
}