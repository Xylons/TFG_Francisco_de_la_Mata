...
public class Tools {
    ...
    public static final String VIEW_MODALITY ="VIEW_MODALITY";
    ...
    public static final String PresRawData0UUID =          basePresureUUID    + "1";
    public static final String PresRawData1UUID =          basePresureUUID    + "2";
    public static final String PresRawData2UUID =          basePresureUUID    + "3";
    ...
    public static final String IMURawDataUUID =       baseIMUUUID        + "1";
